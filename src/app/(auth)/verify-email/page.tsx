...
import { useState, useRef, type ChangeEvent, type KeyboardEvent, Suspense } from "react"
        ...
        <CardContent className="grid gap-4">
            ...
            {otp.map((digit, index) => (
              <input
                ...
                className={`w-12 h-12 text-center text-lg border rounded-[8px] outline-none transition-colors ${
                  digit 
                    ? 'bg-[#9EC7DC] font-bold border-[#9EC7DC] text-white' 
          ...
          <div className="flex justify-center">
            <Button
              ...
              className="w-[240px] h-[50px] text-base font-semibold bg-[#9EC7DC] text-white hover:bg-[#9EC7DC]/90 disabled:opacity-50"
            >
